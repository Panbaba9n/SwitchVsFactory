...
const COLORS_COMPONENTS = {
  'default': ColorsComponent,
  'lollipop': LollipopComponent,
  'thistle': ThistleComponent,
  'floral': FloralComponent,
  'teal': FuchsiaComponent,
  'carnation': CarnationComponent,
  'bubblegum': BubblegumComponent,
  'ruby': RubyComponent,
  'lawn': LawnComponent,
  'honeydew': HoneydewComponent,
  'mindaro': MindaroComponent,
  'pistachio': PistachioComponent,
  'yellow': YellowComponent,
  'cream': CreamComponent,
  'banana': BananaComponent,
  'trombone': TromboneComponent,
}
...
export class ColorFactoryWrapperComponent implements OnChanges, OnDestroy, OnInit {
  ...
  updateComponent() {
    ...
    const componentType: Type<ColorBox> = COLORS_COMPONENTS[this.type] || COLORS_COMPONENTS.default;
